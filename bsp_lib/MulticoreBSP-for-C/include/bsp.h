...
//macros that control the interface follow first:
  ...
  #pragma message "Warning: MCBSP_ENABLE_HP_DIRECTIVES takes precedence over MCBSP_ENABLE_FAKE_HP_DIRECTIVES"
  #undef MCBSP_ENABLE_FAKE_HP_DIRECTIVES
 #endif
#else
 #ifndef MCBSP_ENABLE_FAKE_HP_DIRECTIVES
...
#if MCBSP_MODE == 3
 #ifndef MCBSP_DISABLE_COMPILATION_MODE_WARNING
